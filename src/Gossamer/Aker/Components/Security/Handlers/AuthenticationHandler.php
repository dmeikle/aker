...
namespace Gossamer\Aker\Components\Security\handlers;
 ...
 * eg:
  ...
  user_authentication_provider:
  handler: 'Gossamer\Aker\Components\Providers\UserAuthenticationProvider'
 ...
 *
  simple_auth:
  'handler': 'Gossamer\Aker\Components\Security\handlers\AuthenticationHandler'
